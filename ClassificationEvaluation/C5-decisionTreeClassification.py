...
plot_map(X_train, y_train, classifier, 'DecisionTreeClassifier Boundary')
plot_model(X_train, y_train, classifier, 'DecisionTreeClassifier Train')
plot_model(X_test, y_test, classifier, 'DecisionTreeClassifier Test')
