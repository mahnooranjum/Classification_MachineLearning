...
plot_map(X_train, y_train, classifier, 'SVC RBF Boundary')
plot_model(X_train, y_train, classifier, 'SVC RBF Train')
plot_model(X_test, y_test, classifier, 'SVC RBF Test')
